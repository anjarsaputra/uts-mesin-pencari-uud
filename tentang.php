...
.footer {
   ...
   text-align: center;
    ...
    <title>TUGAS KELOMPOK UTS</title>
      ...
      <div class="container my-auto">
        <div class="row">
          <div class="col-lg-10 mx-auto">
              	<center>
         <h1>KELOMPOK TUGAS UTS </h1>  

<h3>ANJAR SAPUTRA   | 15.01.55.0010 </h3>
<h3>FIKRI ANGGIT H. | 15.01.55.0020 </h3>
<h3>VICKY APRIKA P. | 15.01.55.0019 </h3>
</center>
          </div>
...
<div class="footer">
  <P>Editor :  </P>
<p>ANJAR SAPUTRA | 15.01.55.0010 | SISTEM INFORMASI | FAKULTAS TEKNOLOGI INFORMASI | UNISBANK SEMARANG </p>
</div>